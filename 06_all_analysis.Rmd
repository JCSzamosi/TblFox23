...
[here](./results/06_analysis/goseq_deu_naive.csv')
...
[here](./results/06_analysis/naive_des_sig.csv').
...
`goseq` results [here](./results/06_analysis/goseq_de_naive.csv').
...
[here](./results/06_analysis/diff_des_sig.csv').
...
[here](./results/06_analysis/goseq_de_diff.csv').
